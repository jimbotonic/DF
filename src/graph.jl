...
"""
    get_basic_stats(g::GenericAdjacencyList{T,Array{T,1},Array{Array{T,1},1}}) where {T<:Unsigned}

get # vertices, # of edges and density
NB: for computing density, we assume a directed graph
"""
function get_basic_stats(g::GenericAdjacencyList{T,Array{T,1},Array{Array{T,1},1}}) where {T<:Unsigned}
	nvs = length(G.vertices(g))
	nes = num_edges(g)
...
"""
    get_out_degree_stats(g::GenericAdjacencyList{T,Array{T,1},Array{Array{T,1},1}}) where {T<:Unsigned}
...
""" 
    get_sinks(g::GenericAdjacencyList{T,Array{T,1},Array{Array{T,1},1}}) where {T<:Unsigned}
...
""" 
    get_sources(g::GenericAdjacencyList{T,Array{T,1},Array{Array{T,1},1}}) where {T<:Unsigned}
...
""" 
    subgraph(g::GenericAdjacencyList{T,Array{T,1},Array{Array{T,1},1}},sids::Array{T,1}) where {T<:Unsigned}
...
""" 
    subgraph_streamed(g::GenericAdjacencyList{T,Array{T,1},Array{Array{T,1},1}},sids::Array{T,1},name::String) where {T<:Unsigned}
...
""" 
    get_core(g::GenericAdjacencyList{T,Array{T,1},Array{Array{T,1},1}}) where {T<:Unsigned}
...
""" 
    get_core_streamed(g::GenericAdjacencyList{T,Array{T,1},Array{Array{T,1},1}},sccs::Array{T,1},name::String) where {T<:Unsigned}
...
""" 
    get_reverse_graph(g::GenericAdjacencyList{T,Array{T,1},Array{Array{T,1},1}}) where {T<:Unsigned}
...
""" 
    get_vertex_in_degrees(g::GenericAdjacencyList{T,Array{T,1},Array{Array{T,1},1}}) where {T<:Unsigned}
...
""" 
    get_in_out_degrees(g::GenericAdjacencyList{T,Array{T,1},Array{Array{T,1},1}}) where {T<:Unsigned}
...
""" 
    get_avg_out_degree(g::GenericAdjacencyList{T,Array{T,1},Array{Array{T,1},1}},visited::Array{T,1},p_avg::Float64=float64(-1),np_steps::UInt64=uint64(0)) where {T<:Unsigned}
...
""" 
    get_forward_ball(v::T,g::GenericAdjacencyList{T,Array{T,1},Array{Array{T,1},1}},radius::Int=2,p::Float64=1) where {T<:Unsigned}
...
""" 
    get_clustering_coefficients(g::GenericAdjacencyList{T,Array{T,1},Array{Array{T,1},1}},rg::GenericAdjacencyList{T,Array{T,1},Array{Array{T,1},1}},ntriangles::Array{T,1},density::Float64=-1.) where {T<:Unsigned}
...
""" 
    get_colink_coefficients(g::GenericAdjacencyList{T,Array{T,1},Array{Array{T,1},1}},rg::GenericAdjacencyList{T,Array{T,1},Array{Array{T,1},1}},ncolinks::Array{T,1},density::Float64=-1.) where {T<:Unsigned}
...
""" 
    get_inclist_from_adjlist(g::GenericAdjacencyList{T,Array{T,1},Array{Array{T,1},1}}) where {T<:Unsigned}

get Graphs inclist from Graphs adjlist
"""
function get_inclist_from_adjlist(g::GenericAdjacencyList{T,Array{T,1},Array{Array{T,1},1}}) where {T<:Unsigned}
	g2 = inclist(G.vertices(g), is_directed=true)
...
""" 
    get_sparse_adj_matrix(g::GenericAdjacencyList{T,Array{T,1},Array{Array{T,1},1}}) where {T<:Unsigned}
